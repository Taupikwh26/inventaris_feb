                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($barang->qr_code_path && file_exists(public_path('storage/' . $barang->qr_code_path)))
                                        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('storage/' . $barang->qr_code_path))) }}" alt="QR Code" style="width:80px; height:80px; object-fit:contain;">
                                    @endif
                                </td>
                            </tr>
                        @endforeach
