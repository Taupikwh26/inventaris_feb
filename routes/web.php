...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware'  => 'CheckRole:admin'], function () {
        ...
        Route::get('/laporan-inventaris/export', [LaporanInventarisController::class, 'exportExcel']);
        ...
        Route::get('/laporan-perbaikan/export', [LaporanPerbaikanController::class, 'exportExcel']);
